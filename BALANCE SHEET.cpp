...
cin>> INVENTORY;
DEBIT=LAND_AND_BUILDING+OFFICE_EQUIPMENT+INVENTORY+CASH;
switch(ADD_DEBIT){
case '+':
...
CREDIT=BANK_LOANS_AMOUNT+ACCOUNTS_PAYABLE_AMOUNT+EQUITY_PAID_IN_CAPITAL+RETAINED_EARNINGS;
cout<< "YOUR DEBIT SIDE IS: "<< " "<<CREDIT<<"\n";
switch(ADD_CREDIT){
case '+':
...
if (DEBIT>CREDIT){
    cout<< "YOUR ACCOUNT IS DEBIT" "\n";}
    else (CREDIT>DEBIT);{
        cout<< "YOUR ACCOUNT IS CREDIT" "\n";
    }
